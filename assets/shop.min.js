(function(e){e(document).ready(function(){initHeaderSticky();});e(window).resize(function(){initHeaderSticky();});e(window).scroll(function(){initHeaderSticky();});function initHeaderSticky(){if(jQuery(document).height()>jQuery(window).height()){if(jQuery(window).width()>1199){if(jQuery('.menu-bar').hasClass("sticky_header")){if(jQuery(this).scrollTop()>600)
{jQuery('.menu-bar').addClass("fixed");jQuery('.header_1 .full-header .myaccount').insertAfter('.header_1 .menu-bar .header-middle');jQuery('.header_1 .full-header .header-right').insertBefore('.header_1 .menu-bar .myaccount');}else{jQuery('.menu-bar').removeClass("fixed");jQuery('.header_1 .menu-bar .myaccount').insertBefore('.header_1 .full-header .topmenu');jQuery('.header_1 .menu-bar .header-right').insertBefore('.header_1 .full-header .myaccount');}}else{jQuery('.menu-bar').removeClass("fixed");jQuery('.header_1 .menu-bar .myaccount').insertBefore('.header_1 .full-header .topmenu');jQuery('.header_1 .menu-bar .header-right').insertBefore('.header_1 .full-header .myaccount');}}else{jQuery('.menu-bar').removeClass('fixed');}}}
var cookieName="ttwishlistList";e(document).ready(function(){t.init()
t.closeQuickViewPopup();});e(document).on("click",function(n){var r=e(".quick-view");var i=e("#slidedown-cart");var s=e(".site-header_cart_link");var o=e("#email-modal .modal-window");if(!r.is(n.target)&&r.has(n.target).length===0&&!i.is(n.target)&&i.has(n.target).length===0&&!s.is(n.target)&&s.has(n.target).length===0&&!o.is(n.target)&&o.has(n.target).length===0){t.closeQuickViewPopup();}
...
var t={KidsTimeout:null,isSidebarAjaxClick:false,init:function(){this.initQuickView();this.initAddToCart();this.initAddToCarts();this.initModal();this.initShortcode();this.productAccordion();this.productCompact();this.initProductAddToCart();this.initDropDownCart();this.initWishlist();this.initProductMoreview();this.initSidebar();this.initColorSwatchGrid();this.initInfiniteScrolling();},initColorSwatchGrid:function(){jQuery('.item-swatch li label').click(function(){var newImage=jQuery(this).parent().find('.hidden img').attr('src');jQuery(this).closest('.product-wrapper').find('.featured-image').attr({src:newImage});return false;});jQuery('.item-swatch li label').on('click',function(e){e.preventDefault();var productImage=jQuery(this).parents('.product-wrapper').find('.product-t');productImage.find('img.featured-image').attr('src',jQuery(this).data('image'));});jQuery('.item-swatch li label').on('click',function(e){e.preventDefault();var productImage=jQuery(this).parents('.product-wrapper').find('.grid-view-item__link');productImage.find('img.featured-image').attr('src',jQuery(this).data('image'));});jQuery('.item-swatch li label').on('click',function(e){e.preventDefault();var productPrice=jQuery(this).parents('.product-wrapper').find('.grid-view-item__meta .product-price__sale');productPrice.find('.money').attr('data-currency-usd',jQuery(this).data('price'));});},initWishlist:function(){t.updateWishlistButtons()
...
$(window).resize();setTimeout(function(){$(window).resize();},time);});},initProductMoreview:function(){e('body:not(.rtl) .design_1 .product-wrapper-owlslider .product-single__thumbs.horizontal_bottom').slick({infinite:false,autoplay:false,autoplaySpeed:1500,arrows:true,prevArrow:'<button type="button btn" class="slick-prev"><i class="mdi mdi-chevron-left"></i></button>',nextArrow:'<button type="button btn" class="slick-next"><i class="mdi mdi-chevron-right"></i></button>',slidesToShow:window.number_of_thumb,slidesToScroll:1,responsive:[{breakpoint:1201,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:481,settings:{slidesToShow:2,slidesToScroll:1}}]});e('.slider-for').slick({slidesToShow:1,autoplay:false,slidesToScroll:1,arrows:false,fade:true,asNavFor:'.slider-nav'});e('body:not(.rtl) .slider-nav').slick({infinite:false,autoplay:false,autoplaySpeed:1500,arrows:true,prevArrow:'<button type="button btn" class="slick-prev"><i class="mdi mdi-chevron-left"></i></button>',nextArrow:'<button type="button btn" class="slick-next"><i class="mdi mdi-chevron-right"></i></button>',slidesToShow:2,slidesToScroll:1,asNavFor:'.slider-for',focusOnSelect:true,pauseOnHover:true,responsive:[{breakpoint:1201,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:1260,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:481,settings:{slidesToShow:2,slidesToScroll:1}}]});e('body.rtl .slider-nav').slick({infinite:false,autoplay:false,autoplaySpeed:1500,arrows:true,prevArrow:'<button type="button btn" class="slick-prev"><i class="mdi mdi-chevron-left"></i></button>',nextArrow:'<button type="button btn" class="slick-next"><i class="mdi mdi-chevron-right"></i></button>',slidesToShow:2,slidesToScroll:1,rtl:true,asNavFor:'.slider-for',focusOnSelect:true,responsive:[{breakpoint:1201,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:1260,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:481,settings:{slidesToShow:2,slidesToScroll:1}}]});e('body.rtl .design_1 .product-wrapper-owlslider .product-single__thumbs.horizontal_bottom').slick({infinite:false,autoplay:false,autoplaySpeed:1500,arrows:true,rtl:true,prevArrow:'<button type="button btn" class="slick-prev"><i class="mdi mdi-chevron-left"></i></button>',nextArrow:'<button type="button btn" class="slick-next"><i class="mdi mdi-chevron-right"></i></button>',slidesToShow:window.number_of_thumb,slidesToScroll:1,responsive:[{breakpoint:992,settings:{slidesToShow:4,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:481,settings:{slidesToShow:2,slidesToScroll:1}}]});e('.design_1 .product-wrapper-owlslider .product-single__thumbs.vertical_left,.design_1 .product-wrapper-owlslider .product-single__thumbs.vertical_right').slick({infinite:false,autoplay:false,autoplaySpeed:1500,arrows:true,prevArrow:'<button type="button btn" class="slick-prev"><i class="mdi mdi-chevron-left"></i></button>',nextArrow:'<button type="button btn" class="slick-next"><i class="mdi mdi-chevron-right"></i></button>',vertical:true,slidesToShow:window.number_of_thumb,slidesToScroll:1,responsive:[{breakpoint:1460,settings:{slidesToShow:4,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:481,settings:{slidesToShow:2,slidesToScroll:1}}]});e('.design_4.product-design-compact .product-wrapper-owlslider .product-single__thumbs.horizontal_bottom').slick({infinite:false,autoplay:false,autoplaySpeed:1500,arrows:true,prevArrow:'<button type="button btn" class="slick-prev"><i class="mdi mdi-chevron-left"></i></button>',nextArrow:'<button type="button btn" class="slick-next"><i class="mdi mdi-chevron-right"></i></button>',slidesToShow:window.number_of_thumb_2,slidesToScroll:1,responsive:[{breakpoint:992,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:481,settings:{slidesToShow:2,slidesToScroll:1}}]});e('.design_4.product-design-compact .product-wrapper-owlslider .product-single__thumbs.vertical_left,.design_4.product-design-compact .product-wrapper-owlslider .product-single__thumbs.vertical_right').slick({infinite:false,autoplay:false,autoplaySpeed:1500,arrows:true,prevArrow:'<button type="button btn" class="slick-prev"><i class="mdi mdi-chevron-left"></i></button>',nextArrow:'<button type="button btn" class="slick-next"><i class="mdi mdi-chevron-right"></i></button>',vertical:true,slidesToShow:window.number_of_thumb_2,slidesToScroll:1,responsive:[{breakpoint:992,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:481,settings:{slidesToShow:2,slidesToScroll:1}}]});},showModal:function(n){e(n).fadeIn(500);t.KidsTimeout=setTimeout(function(){e(n).fadeOut(500)},5e3)},showModalCart:function(n){e(n).fadeIn(500);},checkItemsInDropdownCart:function(){if(e("#slidedown-cart .mini-products-list").children().length>0){e("#slidedown-cart .no-items").hide();e("#slidedown-cart .has-items").show()}else{e("#slidedown-cart .has-items").hide();e("#slidedown-cart .no-items").show()}
if(e("#Sticky-slidedown-cart .mini-products-list").children().length>0){e("#Sticky-slidedown-cart .no-items").hide();e("#Sticky-slidedown-cart .has-items").show()}else{e("#Sticky-slidedown-cart .has-items").hide();e("#Sticky-slidedown-cart .no-items").show()}},initModal:function(){e(".continue-shopping").click(function(){clearTimeout(t.KidsTimeout);e(".ajax-success-modal").fadeOut(500)});e(".close-modal,.modal .overlay").click(function(){clearTimeout(t.KidsTimeout);e(".ajax-success-modal").fadeOut(500)})},initDropDownCart:function(){e('.site-header .site-header_cart_link').removeClass('active');e(".site-header .site-header_cart_link").on('click',function(event){event.preventDefault();if(e("#Sticky-slidedown-cart").is(":visible")){e("#Sticky-slidedown-cart").slideToggle("fast");e('.myaccount').removeClass('open');e(".customer_account").slideUp("fast");}else{e("#Sticky-slidedown-cart").slideDown("fast");e('.myaccount').removeClass('open');e(".customer_account").slideUp("fast");}
...
t.checkItemsInDropdownCart()},checkNeedToConvertCurrency:function(){return window.show_multiple_currencies&&Currency.currentCurrency!=shopCurrency},loadQuickViewSlider:function(product,r){var s=Shopify.resizeImage(product.featured_image,"large");r.find(".quickview-featured-image").append('<img height="auto" width="480px" src="'+s+'" title="'+product.title+'"/><div style="height: 100%; width: 100%; top:0px; left:-260px; z-index: 2000; position: absolute; display: none; background: url('+window.loading_url+') 50% 50% no-repeat;"></div>');if(product.images.length>1){var o=r.find(".more-view-wrapper ul");for(var i=0;i<4;i++){var u=Shopify.resizeImage(product.images[i],"large");var a=Shopify.resizeImage(product.images[i],"small");var f='<li><a href="javascript:void(0)" data-image="'+u+'"><img height="auto" width="100px" src="'+a+'"  /></a></li>';o.append(f)}
...
n.preventDefault();});},sidebarMapTagEvents:function(){if(jQuery(window).width()<992){jQuery(".sidebar .widget > h4").addClass("toggle");jQuery(".sidebar .widget ").children(':nth-child(2)').css('display','none');jQuery(".sidebar .widget.active").children(':nth-child(2)').css('display','block');jQuery(".sidebar .widget > h4.toggle").unbind("click");jQuery(".sidebar .widget > h4.toggle").on('click',function(){jQuery(this).parent().toggleClass('active').children(':nth-child(2)').slideToggle("fast");});}
if(jQuery(window).width()<992){jQuery(".sidebar-block .widget > h4").addClass("toggle");jQuery(".sidebar-block .widget ").children(':nth-child(2)').css('display','none');jQuery(".sidebar-block .widget.active").children(':nth-child(2)').css('display','block');jQuery(".sidebar-block .widget > h4.toggle").unbind("click");jQuery(".sidebar-block .widget > h4.toggle").on('click',function(){jQuery(this).parent().toggleClass('active').children(':nth-child(2)').slideToggle("fast");});}
...
e(".refined-widgets").replaceWith(e(data).find(".refined-widgets"));e(".sidebar .refined-widgets").replaceWith(e(data).find(".sidebar .refined-widgets"));e(".filter-toggle-wrap .refined-widgets").replaceWith(e(data).find(".filter-toggle-wrap .refined-widgets"));e(".sidebar .sidebar-block").replaceWith(e(data).find(".sidebar .sidebar-block"));e(".filter-toggle-wrap .sidebar-block").replaceWith(e(data).find(".filter-toggle-wrap .sidebar-block"));countDownIni('.flip-countdown');if(e(".pagination-wrap").length>0){e(".pagination-wrap").replaceWith(e(data).find(".pagination-wrap"));}else{e(e(data).find(".pagination-wrap")).insertAfter(".col-main");}
if(localStorage.getItem('display')=='grid'){jQuery('#grid-view').trigger('click');}else{jQuery('#list-view').trigger('click');}
...
if(window.show_multiple_currencies&&window.shop_currency!=jQuery(".currencies li.active .currencies-a").val()){Currency.convertAll(window.shop_currency,jQuery('.currencies li.active .currencies-a').val(),"span.money","money_format")}
